# ModelSim simulation script for Top Module - New Architecture
...
add wave -noupdate -divider "Audio Clocks & Counters"
...
add wave -color magenta /top_tb/dut/audio_router_inst/sclk_12288_counter
...
add wave -noupdate -divider "Input Data Buses - FF"
add wave -color white -radix binary /top_tb/sdi_ff_bus
add wave -color white -radix hex /top_tb/captured_sdi_ff
add wave -color white -radix hex /top_tb/buf_captured_sdi_ff
add wave -color white -radix hex /top_tb/captured_i2s_ff
add wave -color green -radix hex /top_tb/dut/audio_router_inst/ff_channels
add wave -color white -radix hex /top_tb/lrck_48
add wave -color white -radix hex /top_tb/dut/audio_router_inst/sclk_3072_counter

add wave -noupdate -divider "Input Data Buses - LoopBack"
add wave -color white -radix binary /top_tb/sdi_loopback
add wave -color white -radix hex /top_tb/captured_sdi_lb
add wave -color white -radix hex /top_tb/buf_captured_sdi_lb
add wave -color white -radix hex /top_tb/captured_i2s_lb
add wave -color green -radix hex /top_tb/dut/audio_router_inst/loopback_channels

add wave -noupdate -divider "FF + LoopBack output buffer"
add wave -color green -radix hex /top_tb/dut/audio_router_inst/channel_buffer

add wave -noupdate -divider "I2S Output Data"
add wave -color white -radix hex /top_tb/i2s_data_out
