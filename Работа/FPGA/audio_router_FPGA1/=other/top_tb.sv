...
always #80 sclk_3072 = ~sclk_3072;  // 3.072MHz
always #5120 lrck_48 = ~lrck_48;   // 48kHz

// Заполняем входные данные
// Добавьте новые сигналы для отслеживания состояния
reg [4:0] bit_counter;
reg lrck_48_prev;
...
always #10 clk_400khz = ~clk_400khz;  // 400kHz
