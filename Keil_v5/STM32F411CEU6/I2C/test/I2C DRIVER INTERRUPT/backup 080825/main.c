...
uint8_t I2C_WriteReadByte(I2C_TypeDef* I2Cx, uint8_t addr, uint8_t data);
...
int main(void) {
    ...
    receivedData_from_slave = I2C_WriteReadByte(I2C1, SLAVE_ADDR, dataToSend);
    while(1) {
    }
}
...
void I2C_BeginAt(I2C_TypeDef* I2Cx, uint8_t addr, uint8_t op) {
    ...
    volatile uint32_t _dummy = I2Cx->SR1 | I2Cx->SR2;  // Clear ADDR flag
    (void)_dummy;
}
...
uint8_t I2C_WriteReadByte(I2C_TypeDef* I2Cx, uint8_t addr, uint8_t data) {
    ...
    I2C_Start(I2Cx);
    I2C_BeginAt(I2Cx, addr, 0);  // 0 = Write operation
    I2C_Write(I2Cx, data);
    I2C_Stop(I2Cx);
    
    I2C_Start(I2Cx);
    I2C_BeginAt(I2Cx, addr, 1);
    
    //I2Cx->CR1 &= ~(1 << I2C_CR1_ACK);
    receivedData = I2C_ReadByte(I2Cx);
    I2C_Stop(I2Cx);
